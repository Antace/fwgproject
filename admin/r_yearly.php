<div class="container">
    <div class="row">
        <div class="col-md-12">
            <?php
            $query = "
            SELECT sale_stotal, SUM(sale_stotal) AS totol, DATE_FORMAT(sale_dt, '%Y') AS sale_dt
            FROM tb_sale
            GROUP BY DATE_FORMAT(sale_dt, '%Y%')
            ORDER BY DATE_FORMAT(sale_dt, '%Y') DESC
            ";
            ...
            ?>
            <h3 align="center">รายงานการขายประจำปี (รวมภาษี)</h3>
