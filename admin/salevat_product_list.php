<?php
  ...
  if (@$_GET['do'] == 'success') {
    ...
    echo '<meta http-equiv="refresh" content="1;url=salevat.php" />';
...
ORDER BY sale_id DESC" or die("Error:" . mysqli_error($con));
  ...
  while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<td align=center><a href='salevat.php?act=view&ID=$row[sale_id]' class='btn btn-warning btn-xs'>เปิด</a>
    <a href='salevat.php?act=salevat_cancel&ID=$row[sale_id]' class='btn btn-danger btn-xs'>คืนสินค้า</a>
