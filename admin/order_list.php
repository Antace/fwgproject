...
<td align=center><a href='order.php?act=view&ID=<?php echo $row["order_id"];?>' class='btn btn-warning btn-xs'>เปิด</a>
  <a href='order.php?act=order_cancel&ID=<?php echo $row["order_id"];?>' class='btn btn-danger btn-xs'>ลบ</a>
  <a href='order.php?act=print&ID=<?php echo $row["order_id"];?>' class='btn btn-info btn-xs'><i class='fas fa-print'></i></a>
</td>
  </tr>
<?php } ?>
