...
WHERE payment_id=$ID" or die("Error:" . mysqli_error($con));
...
<div class="container">
            ...
            <div class="col-sm-12">
            <h3 align="center">ใบบันทึกส่งงาน ผรม. โรงงาน</h3>
            <table  class = "table table-borderless" width="100%">

            <tr>
            <td width = "10%">เลขที่</td>
            <td width = "20%"><?php echo $row['payment_id'];?> </td>
            <td></td>
            <td></td>
            <td width = "10%">วันที่</td>
            <td width = "20%"><?php echo date('d/m/Y', strtotime($row['payment_date']))?></td>
            </tr>
            <tr>
...
<div class="container">
            ...
            <th width='40%'><center>รายการ</center></th>
            <th width='10%'><center>ราคา/หน่วย</center></th>
            <th width='10%'><center>จำนวน</center></th>
            <th width='10%'><center>หน่วย</center></th>
...
<?php
        ...
        $mpdf->WriteHTML($html);
        //$filename = 'payment'.'_'.date('D-d-m-Y-H-i-s').'.pdf';
