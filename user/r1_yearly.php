<div class="container">
    <div class="row">
        <div class="col-md-12">
            <?php
            $query = "
            SELECT salenv_stotal, SUM(salenv_stotal) AS totol, DATE_FORMAT(salenv_dt, '%Y') AS salenv_dt
            FROM tb_salen
            GROUP BY DATE_FORMAT(salenv_dt, '%Y%')
            ORDER BY DATE_FORMAT(salenv_dt, '%Y') DESC
            ";
            ...
            ?>
            <h3 align="center">รายงานการขายประจำปี</h3>
