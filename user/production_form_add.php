                                            ...
                                            <table width="600" border="0" align="center" class="table table-bordered table-striped">
                                                ...
                                                if (!empty($_SESSION['production'])) {
                                                    foreach ($_SESSION['production'] as $product_id => $qty) {
                                                        ...
                                                        echo '<select class="select2bs4" data-placeholder="โครงการ" name ="department_name" style="width: 100%;" >';
                                                        echo '<option value="">-</option>';
                                                        foreach ($result3 as $results) {
                                                            echo '<option value=" $results["department_name"]">';
                                                            echo $results["department_name"];
                                                            echo '</option>';
                                                        }
                                                        echo '</select>';
                                                        echo '</td>';
                                                        ...
                                                        echo "<td width='57' >";
                                                        echo "<input type='text' class='form-control' name='production_place' value=''  /></td>";
