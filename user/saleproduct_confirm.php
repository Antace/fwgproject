            ...
            <body>
                <script language="JavaScript">
                    ...
                    function resutName(strCusName) {
                        frmcart.customer_id.value = strCusName.split("|")[0];
                        frmcart.customer_name.value = strCusName.split("|")[1];
                        frmcart.customer_address.value = strCusName.split("|")[2];
                        frmcart.customer_branch.value = strCusName.split("|")[3];
                        frmcart.customer_tax.value = strCusName.split("|")[4];
                    }
                </script>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="frmcart" name="frmcart" method="post" action="saleproduct_db.php">
                                                ...
                                                <p>
                                                    ...
                                                    <center><a href="sale_form_add1.php" class="btn btn-warning ">กลับหน้ายืนยันการสั่งซื้อ</a> &nbsp;&nbsp;<input type="submit" name="Submit2" class="btn btn-success" value="สั่งซื้อ" /></center>
                                            </form>
                                            <!-- /.card-body -->
                                        </div>
                                        <!-- /.card -->
